    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, null, "merveil@test.com", "merveil Nzitusu", null, "bruno", "merveil", 0, 2 },
                    { 3, null, "iglesias@test.com", "iglesias Chendjou", null, "iglesias", "iglesias", 0, 2 },
                    { 1, null, "ben@test.com", "Benoît Penelle", null, "ben", "ben", 0, 1 },
