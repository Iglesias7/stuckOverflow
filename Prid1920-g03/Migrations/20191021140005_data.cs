    ...
    public partial class data : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "ben@test.com", "Benoît Penelle", null, "ben", "ben", 0 },
                    { 2, null, "ben@test.com", "Bruno Lacroix", null, "bruno", "bruno", 0 },
                    { 3, null, "ben@test.com", "iglesias Chendjou", null, "iglesias", "iglesias", 0 },
                    { 4, null, "ben@test.com", "merveil Nzitusu", null, "bruno", "merveil", 0 }
                });
